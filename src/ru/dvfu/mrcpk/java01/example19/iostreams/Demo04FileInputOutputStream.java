...
public class Demo04FileInputOutputStream {
    public static void main(String[] args) throws IOException {
        ...
        FileInputStream inputStream = new FileInputStream("/home/gorynych/java/file04.txt");
        // Поток на запись байт в файл
        FileOutputStream outputStream = new FileOutputStream("/home/gorynych/java/file041.txt");
